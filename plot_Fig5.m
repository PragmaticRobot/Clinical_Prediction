...
FM_RF_L = xlsread('2016dec12_FM_RF_L_R2_meta_26C1.csv');
FM_RF_Q = xlsread('2016dec12_FM_RF_Q_R2_meta_26C1.csv');
FM_LS_L = xlsread('2016dec12_FM_LS_Q_R2_meta_26C1.csv');
FM_LS_Q = xlsread('2016dec12_FM_LS_L_R2_meta_26C1.csv');
...
VN1 = [V_WO_LS_L,V_WO_LS_L2(end:-1:1)];
VN2 = [V_WO_LS_Q,V_WO_LS_Q2(end:-1:1)];
VN3 = [V_WO_RF_L,V_WO_RF_L2(end:-1:1)];
VN4 = [V_WO_RF_Q,V_WO_RF_Q2(end:-1:1)];
...
patch(Vx,VN1,colors(1,:),'FaceAlpha',0.3,'EdgeColor','none');
patch(Vx,VN2,colors(2,:),'FaceAlpha',0.3,'EdgeColor','none');
patch(Vx,VN3,colors(3,:),'FaceAlpha',0.3,'EdgeColor','none');
patch(Vx,VN4,colors(4,:),'FaceAlpha',0.3,'EdgeColor','none');
