...
write.csv(FM_LS_L,"mod1_v13.csv")
write.csv(FM_LS_Q,"mod2_v13.csv")
write.csv(WO_LS_L,"mod5_v13.csv")
write.csv(WO_LS_Q,"mod6_v13.csv")
...
save(FM_LS_L_beta, FM_LS_Q_beta,WO_LS_L_beta,WO_LS_Q_beta,
     FM_LS_L,FM_LS_Q,WO_LS_L,WO_LS_Q, file = "LS_v13.rda")
...
# nReps <- 100 # number of cross-validation repeats
# nFolds <- 13 # number of folds in each cv
...
# }
# 
# write.csv(FM_RF_L,"mod3_v10.csv")
# write.csv(FM_RF_Q,"mod4_v10.csv")
# write.csv(WO_RF_L,"mod7_v10.csv")
# write.csv(WO_RF_Q,"mod8_v10.csv")
# 
# save(FM_RF_L,FM_RF_Q,WO_RF_L,WO_RF_Q,FM_RF_L_VI,FM_RF_Q_VI,WO_RF_L_VI,WO_RF_Q_VI, file = "RF_v10.rda")